...
_binlibs(){
	...
	SHARESAVED="gstreamer" # Enter here keywords or file/folder names to save in /usr/lib. By default, the names of the folders that you will save in /usr/share are selected also here.
