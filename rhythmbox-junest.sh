...
DEPENDENCES="ca-certificates libmtp libpeas python"
...
BINSAVED="certificates py" # Enter here keywords to find and save in /usr/bin
SHARESAVED="certificates gstreamer icons" # Enter here keywords or file/directory names to save in both /usr/share and /usr/lib
...
LIBSAVED="pk p11 alsa jack pipewire pulse libmtp $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
...
function _remove_more_bloatwares() {
	...
	rm -R -f ./"$APP".AppDir/.junest/usr/share/icons/*dwaita
}
