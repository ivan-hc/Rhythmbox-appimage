...
DEPENDENCES="brasero gst-libav gst-plugins-bad gst-plugins-base gst-plugins-base-libs gst-plugins-good gst-plugins-ugly gstreamer gvfs gvfs-mtp json-glib libdmapsharing libpeas libgpod lirc media-player-info python python-gobject zeitgeist" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
