...
rm -R -f ./$APP.AppDir/.junest/usr/lib/libxtracker*
...
mv ./*AppImage ./"$(cat ./$APP.AppDir/*.desktop | grep 'Name=' | head -1 | cut -c 6- | sed 's/ /-/g')"_"$VERSION""$VERSIONAUR"-ivanhcrevision20231123-x86_64.AppImage
